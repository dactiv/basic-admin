  ...
  <a-card title="发送站内信" class="basic-box-shadow margin-lg-top">
    ...
    <a-form ref="edit-form" :model="form" :rules="rules" layout="vertical">
      ...
      <a-space :size="10">
        ...
        <a-upload v-if="principal.hasPermission('perms[message:send]')" :showUploadList="false" :multiple="true" v-model:file-list="fileList" action="/message/attachment/upload/site" @change="fileListChange">
          <a-button>
