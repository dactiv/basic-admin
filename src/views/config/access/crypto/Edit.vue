<template>
  ...
  <a-breadcrumb class="hidden-xs">
    ...
    <a-breadcrumb-item><router-link :to="{name:'access_crypto'}"> <icon-font type="icon-crypto-currency-bitcoin-imac"/> 访问加解密管理</router-link></a-breadcrumb-item>
    <a-breadcrumb-item><icon-font type="icon-edit" /> {{ (form.id ? '编辑 [' + form.name + '] ': '添加') + '访问加解密' }}</a-breadcrumb-item>
  </a-breadcrumb>
