<template>
  ...
  <a-breadcrumb class="hidden-xs">
    ...
    <a-breadcrumb-item><router-link :to="{name:'dictionary_type_edit', query:{id:typeEntity.id}}"><icon-font type="icon-dictionary" /> {{ '编辑 [' + typeEntity.name + '] ' + '字典类型' }}</router-link></a-breadcrumb-item>
    <a-breadcrumb-item><icon-font type="icon-edit" /> {{ (form.id ? '编辑 [' + form.name + '] ': '添加') + '数据字典' }}</a-breadcrumb-item>
  </a-breadcrumb>
