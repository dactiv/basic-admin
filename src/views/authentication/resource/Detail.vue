<template>
  ...
  <a-breadcrumb class="hidden-xs">
    ...
    <a-breadcrumb-item><icon-font type="icon-file" /> {{ '[' + form.name + ']' + '資源明细' }}</a-breadcrumb-item>
  </a-breadcrumb>
  ...
  <a-card :title="'[' + form.name + ']' + '資源明细'" class="basic-box-shadow">
    ...
    <a-spin :spinning="spinning">
      ...
      >
        ...
        <a-descriptions-item label="名称"><icon-font v-if="form.icon" :type="form.icon" /> {{form.name}} </a-descriptions-item>
