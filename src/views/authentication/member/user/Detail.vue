<template>
  ...
  <a-breadcrumb class="hidden-xs">
    ...
    <a-breadcrumb-item><router-link :to="{name:'authentication_member_user'}"><icon-font class="icon" type="icon-user-groups" /> 会员用户管理</router-link></a-breadcrumb-item>
...
export default {
  name:"AuthenticationMemberUserDetail",
  data() {
    return {
      spinning:true,
      form: {
